#202136139 박세호
# An open CV that filters a particular object form detected objects.
# Shows the quantity of objects and image of the objects being filtered.
import cv2
import numpy as np
...
def filtered_objects():
    ...
    # Type an object to filter
    obj = input("Enter an object to fliter: ")
    quantity = 0 # Quantity of filtered objects
    ...
    # Print quantity of filtered objects
    print('Quantity of the filtered objects: ', quantity)
    cv2.imshow('Filtered Objects', img) # Show filtered image
    cv2.waitKey()
